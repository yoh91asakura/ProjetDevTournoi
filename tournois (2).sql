...
--
-- Client: localhost
-- Généré le: Jeu 21 Mars 2013 à 09:50
...
CREATE TABLE IF NOT EXISTS `equipe` (
  ...
  `idPoule` tinyint(2) NOT NULL,
  `scorePoule` tinyint(4) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
('Bitokus', 6, 'lapinator', 'robert', 0, 5),
('lapin5', 9, 'johansonne', 'thibault', 0, 7),
('abricots', 8, 'kolik', 'kirill', 0, 0),
('lokalStronk', 6, 'obito', 'toralis', 0, 1),
('extWeak', 6, 'brant', 'edouard', 0, 3),
('rapace', 6, 'dedroit', 'piaf', 0, 0),
('falin', 6, 'le chat', 'félix', 0, 0);
...
CREATE TABLE IF NOT EXISTS `rencontrepoule` (
  ...
  `idterrain` smallint(5) unsigned NOT NULL,
  `idarbitre` int(10) unsigned NOT NULL,
  `numsemaine` tinyint(3) NOT NULL,
  `jour` varchar(10) NOT NULL,
  `equipe1` varchar(50) NOT NULL,
  `equipe2` varchar(50) NOT NULL,
  `set1equipe1` tinyint(4) NOT NULL,
  `set1equipe2` tinyint(4) NOT NULL,
  `set2equipe1` tinyint(4) NOT NULL,
  `set2equipe2` tinyint(4) NOT NULL,
  `set3equipe1` tinyint(4) NOT NULL,
  `set3equipe2` tinyint(4) NOT NULL,
